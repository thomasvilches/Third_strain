...
rc = [1.0;map(y->1.0+(0.14/6)*y,1:6);map(y->1.14-(0.135/11)*y,1:11);map(y->1.005-(0.15/31)*y,1:31);map(y->0.856+(0.065/10)*y,1:10);map(y->0.921-(0.18/30)*y,1:30);map(y->0.741+(0.24/12)*y,1:12)]
...
dc = [1;map(y->115+y,0:17);map(y->173+y,0:22);map(y->204+y,0:84);map(y->310+y,0:13)]
rc = [1.0;map(y->1.0-(0.1206/18)*y,1:18);map(y->0.8794+(0.18/23)*y,1:23);map(y->1.0594-(0.3594/85)*y,1:85);map(y->0.70+(0.27/14)*y,1:14)]
...
rc = [1.0;map(y->1.0-(0.23/20)*y,1:20);map(y->0.77+(0.14/15)*y,1:15);map(y->0.91-(0.20/45)*y,1:45);map(y->0.71+(0.25/17)*y,1:17)]
...
rc = [1.0;map(y->1.0-(0.118/17)*y,1:17);map(y->0.882+(0.05/5)*y,1:5);map(y->0.932-(0.0865/30)*y,1:30)]
