...
dc = [1;map(y->92+y,0:23);map(y->219+y,0:34);map(y->305+y,0:27)]
rc = [1.0;map(y->1.0-(0.144/24)*y,1:24);map(y->0.856-(0.27/35)*y,1:35);map(y->0.586+(0.205/28)*y,1:28)]
run_param_scen_cal(0.116,"ohio",6,20,1,1,1,1,1,120,177,196,999,177,0.2,1,2,14,rc,dc,487,true)
run_param_scen_cal(0.116,"ohio",6,20,1,1,1,1,1,120,177,196,999,177,0.2,2,2,14,rc,dc,487,true,"statuscuo",1.0,0.5)
#run_param_scen_cal(0.116,"ohio",6,20,1,1,1,1,1,120,177,196,999,177,0.2,2,2,14,rc,dc,365,false)
#run_param_scen_cal(0.116,"ohio",6,20,1,1,1,1,1,120,177,196,999,177,0.2,3,2,14,rc,dc,365,true,"fast",1.36)
...
#run_param_scen_cal(0.106,"florida",6,40,1,1,1,1,1,106,106,216,137,155,0.2,2,2,14,rc,dc,365,false)
#run_param_scen_cal(0.106,"florida",6,40,1,1,1,1,1,106,106,216,137,155,0.2,3,2,14,rc,dc,365,true,"fast",1.32)
...
#run_param_scen_cal(0.06705,"texas",6,45,45,1,1,1,1,1,139,210,129,123,0.2,2,2,14,rc,dc,365,false)
#run_param_scen_cal(0.06705,"texas",6,45,45,1,1,1,1,1,139,210,129,123,0.2,3,2,14,rc,dc,365,true,"fast",1.35)
