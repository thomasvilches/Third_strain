...
run_param_scen_cal(0.1146,"ohio",5,20,1,1,1,1,1,120,177,196,999,177,0.2,1,2,14,rc,dc,365,true)
...
dc = [1;map(y->105+y,0:34);map(y->228+y,0:11);map(y->295+y,0:17)]#]
rc = [1.0;map(y->1.0-(0.108/35)*y,1:35);map(y->0.892-(0.07/12)*y,1:12);map(y->0.892+(0.16/18)*y,1:18)]#]
run_param_scen_cal(0.0735,"alabama",10,50,40,1,40,1,1,1,1,228,1,190,0.2,1,2,14,rc,dc,487,true)
run_param_scen_cal(0.0735,"alabama",10,50,40,1,40,1,1,1,1,228,1,190,0.2,2,2,14,rc,dc,487,true,"statuscuo",1.0,0.5)
